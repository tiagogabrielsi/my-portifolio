...
const TRANSLATIONS = {
  pt: {
    ...
    'hero.desc': 'Estudante de Sistemas de Informação, com base técnica em Agronegócio — unindo ciência, dados e tecnologia. Foco atual em desenvolvimento de software e hardware, em busca da primeira oportunidade internacional em TI.',
    ...
    'hero.roles': [
      ...
      'Interessado em Hardware & Software',
      'Entre Agronegócio e Tecnologia',
    ...
    'about.p1': 'Sou estudante de Sistemas de Informação, com formatura prevista para 2028. Tenho interesse em entender como as coisas funcionam por trás dos panos — do código à própria máquina que executa ele.',
    'about.p2': 'Tenho interesse especial em hardware: montagem e otimização de computadores, processadores, placas de vídeo e como cada componente impacta a performance. No campo do software, venho estudando programação com foco em desenvolvimento web e boas práticas de engenharia.',
    'about.p3': 'Antes da faculdade, me formei Técnico em Agronegócio (2021–2023), formação que uniu ciência, gestão de processos e tecnologia aplicada ao campo. Essa base trouxe disciplina e visão analítica, hoje aplicadas ao desenvolvimento de software. Meu objetivo é atuar como profissional de tecnologia no exterior.',
    ...
    'formacao.item2B1': 'Formação técnica que uniu ciência e tecnologia aplicada ao agronegócio, desenvolvendo disciplina e visão de processos.',
    'contact.title': 'Contato',
    'contact.heading': 'Vamos trabalhar juntos?',
    'contact.body': 'Estou em busca de estágio ou de uma primeira oportunidade, no Brasil ou no exterior. Envie uma mensagem e retornarei o mais breve possível.',
  ...
  en: {
    ...
    'hero.eyebrow': "Hi, I'm",
    'hero.rolePrefix': "I'm ",
    'hero.desc': 'Information Systems student with a technical background in Agribusiness — bridging science, data and technology. Currently focused on software and hardware development, seeking a first international opportunity in tech.',
    ...
    'hero.roles': [
      ...
      'Interested in Hardware & Software',
      'Between Agribusiness and Technology',
    ...
    'about.p1': "I'm an Information Systems student, expected to graduate in 2028. I have an interest in understanding how things work under the hood — from code down to the machine that runs it.",
    'about.p2': 'I have a particular interest in computer hardware: building and optimizing computers, processors, graphics cards, and how each component impacts performance. On the software side, I have been studying programming with a focus on web development and engineering best practices.',
    'about.p3': 'Before college, I completed a technical degree in Agribusiness (2021–2023), a program that combined science, process management and technology applied to agriculture. That background brought discipline and an analytical mindset, now applied to software development. My goal is to work as a technology professional abroad.',
    ...
    'formacao.item2B1': 'Technical education that combined science and technology applied to agribusiness, building discipline and a process-oriented mindset.',
    'contact.title': 'Contact',
    'contact.heading': "Let's work together?",
    'contact.body': "I'm looking for an internship or a first opportunity, in Brazil or abroad. Send a message and I'll get back to you as soon as possible.",
