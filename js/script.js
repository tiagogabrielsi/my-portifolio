...
const TRANSLATIONS = {
  pt: {
    ...
    'projects.name1': 'TerraSeq',
    'projects.name2': 'Nome do Projeto 2',
    'projects.name3': 'Nome do Projeto 3',
    'projects.desc1': 'Plataforma de bioinformática para validação in silico de primers de metabarcoding/eDNA de organismos do solo. Pesquisadores enviam pares de primers via Google Forms ou GitHub Issues, e o pipeline roda BLAST contra bancos de genomas curados por grupo taxonômico, publicando um relatório interativo automaticamente no GitHub Pages.',
  ...
  en: {
    ...
    'projects.desc1': 'Bioinformatics platform for in silico validation of metabarcoding/eDNA primers targeting soil organisms. Researchers submit primer pairs via Google Forms or GitHub Issues, and the pipeline runs BLAST against curated, taxonomy-grouped genome databases, automatically publishing an interactive report to GitHub Pages.',
