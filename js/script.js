...
const TRANSLATIONS = {
  pt: {
    ...
    'about.p1': 'Sou graduando em Sistemas de Informação, com formatura prevista para 2028. Tenho interesse em desenvolver projetos e me especializar em novas tecnologias, aprendendo o que cada novo desafio exige.',
    'about.p2': 'Meu foco profissional está no desenvolvimento back-end e front-end, com interesse em boas práticas de engenharia de software e em construir aplicações web robustas e bem estruturadas.',
    'about.p3': 'Sou formado em Técnico em Agronegócio (2021–2023) pela EEEFM Prof. Aldy Soares Mercon Vargas, através do Pronatec — período em que também tive contato com bioinformática aplicada ao estudo de organismos do solo. Essa vivência uniu ciência e tecnologia, hoje direcionadas ao desenvolvimento de software.',
  ...
  en: {
    ...
    'about.p1': "I'm an Information Systems undergraduate, expected to graduate in 2028. I have an interest in building projects and specializing in new technologies, learning what each new project demands.",
    'about.p2': 'My professional focus is on back-end and front-end development, with an interest in software engineering best practices and building robust, well-structured web applications.',
    'about.p3': 'I hold a technical degree in Agribusiness (2021–2023) from EEEFM Prof. Aldy Soares Mercon Vargas, through the Pronatec program — a period during which I also worked with bioinformatics applied to the study of soil organisms. That experience combined science and technology, now channeled into software development.',
